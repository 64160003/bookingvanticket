...
<div class="summary-container">
    ...
    @if($validatedData['payment_method'] === 'online_qr')
        <div class="qr-code-section">
            ...
            <form action="{{ route('upload.slip') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                @csrf
    ...
    @else
        <p>Please pay at the shop. Thank you!</p>
    @endif

    <div class="buttons-container">
        <a href="{{ route('customer') }}?schedule_id={{ $schedule->ScheduleID }}&origin_id={{ $origin->RouteID }}&destination_id={{ $destination->idRouteDown }}&seats={{ $seats }}" class="btn back-btn">Back to Customer Info</a>
        {{-- <a href="#" class="btn confirm-btn">Confirm Purchase</a> --}}
    </div>

    <!-- Modal for cancellation -->
    <div id="cancel-modal" style="display: none; background-color: rgba(0,0,0,0.5); position: fixed; top: 0; left: 0; width: 100%; height: 100%; justify-content: center; align-items: center;">
